...
//#include "../../../annotation/fpdf_richtext.h"
...
void CFX_Edit::SetRichTextForXML(FX_LPCWSTR xml, FX_LPCWSTR ds/* = NULL */, FX_BOOL bAutoSetAgin)
{
	//TODO: richtext!!
	//Empty();
	//CPDF_RichTextXML richXML;
	//richXML.SetXML(xml, ds);
	//richXML.XMLToFXEdit(this, this->GetFontMap(),bAutoSetAgin);
}
...
{
	FX_INT32 iFontSize = GetFontSize();
	if (IsTextOverflow())
	{
		if (iFontSize > 1)
