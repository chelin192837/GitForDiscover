...
class IFX_Edit_FontMap :  public CFX_Object
{
public:
	//release this object.
...
struct EDIT_FONT_DATA
{
	...
	CPDF_Font* pFont;
	CFX_ByteString fontAName;
};

typedef CFX_ArrayTemplate<EDIT_FONT_DATA> CFX_EditFontArray;
...
public:
	...
	virtual void							SetRichTextForXML(FX_LPCWSTR xml, FX_LPCWSTR ds/* = NULL */, FX_BOOL bAutoSetAgin) = 0;
...
public:
	...
	static CFX_ByteString					GetRichEditAppearanceStream(IFX_Edit* pEdit, const CPDF_Point & ptOffset, const CPVT_WordRange * pRange = NULL, FX_BOOL bContinuous = TRUE, CFX_EditFontArray* fontindexlist = NULL);
