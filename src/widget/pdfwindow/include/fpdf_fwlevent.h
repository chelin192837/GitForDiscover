 ...
 * @details	The content of this header file is an extension of the fwl event module.
 ...
 *			request for enabling PDF Form Field module explicitly. 
 * @version 2.0
 */

/** 
 * @addtogroup FPDFFORMFIELD PDF Form Field
...
#ifndef _FSCRT_BASE_H_
#include "../../../../include/common.h"
#endif

#ifndef _FSCRT_DEF_FWLEVENTTYPE_
#define _FSCRT_DEF_FWLEVENTTYPE_
...
#ifndef _FSCRT_DEF_FWLEVENTFLAG_
#define _FSCRT_DEF_FWLEVENTFLAG_
...
#ifndef _FSCRT_DEF_FWLEVENTMOUSECMD_
#define _FSCRT_DEF_FWLEVENTMOUSECMD_
...
#ifndef _FSCRT_DEF_EVENTMOUSE_
#define _FSCRT_DEF_EVENTMOUSE_
...
#ifndef _FSCRT_DEF_EVENTMOUSEWHEEL_
#define _FSCRT_DEF_EVENTMOUSEWHEEL_
...
#ifndef _FSCRT_DEF_FWLVKEYCODE_
#define _FSCRT_DEF_FWLVKEYCODE_
...
typedef enum _FWL_VKEYCODE_
{
  ...
  FWL_VKEY_Up			= 0x26,	/**< @brief  Up arrow key. */
  ...
  FWL_VKEY_Multiply = 0x6A,		/**< @brief  Multiply key in the numeric keypad. */
  FWL_VKEY_Add		= 0x6B,		/**< @brief  Plus key in the numeric keypad. */
  FWL_VKEY_Separator = 0x6C,	/**< @brief  Enter key in the numeric keypad. */
  FWL_VKEY_Subtract	= 0x6D,		/**< @brief  Minus key in the numeric keypad. */
  FWL_VKEY_Decimal	= 0x6E,		/**< @brief  Dot key in the numeric keypad. */
  FWL_VKEY_Divide	= 0x6F,		/**< @brief  Slash key in the numeric keypad. */
...
#ifndef _FSCRT_DEF_FWLEVENTKEYCMD_
#define _FSCRT_DEF_FWLEVENTKEYCMD_
...
#ifndef _FSCRT_DEF_EVENTKEY_
#define _FSCRT_DEF_EVENTKEY_
