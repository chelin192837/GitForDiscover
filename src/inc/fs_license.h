#ifndef _FS_LICENSE_H_
#define _FS_LICENSE_H_

#if !defined(_FS_LICENSED_BUILD_) && (defined(_LICENSED_BUILD_)||(_FX_OS_==_FX_ANDROID_) || (_FX_OS_==_FX_IOS_))
#define _FS_LICENSED_BUILD_
#endif
...
#define _FS_EOSDK_			9
#define _FS_MRSDK_			100

#ifndef _FX_PRODUCT_
#define _FX_PRODUCT_ _FS_MRSDK_
#endif
...
#define _FS_PRODUCTNAME_MRSDK_		L"Foxit OFD MRSDK"
...
#define _FS_PRODUCTAB_MRSDK_		L"SK"
...
#elif _FX_PRODUCT_ == _FS_MRSDK_
	#define _FS_PRODUCTNAME_	_FS_PRODUCTNAME_MRSDK_
	#define _FS_PRODUCTAB_		_FS_PRODUCTAB_MRSDK_
	#define _FS_VERSION_MAJOR	2
	#define _FS_VERSION_INTER	0
	#define _FS_VERSION_MINOR	0
	#define _FS_KEYFILE_		L"fsmrkey.txt"
#else
...
#define _FS_OS_ANDROID_		L'A'
#define _FS_OS_IOS_			L'I'
#define _FS_OS_NONE_		L'N'
	...
	#define _FS_OS_		_FS_OS_ANDROID_
	#define _FS_OSNAME_	L"Android"
#elif _FX_OS_ == _FX_IOS_
	#define _FS_OS_		_FS_OS_IOS_
	#define _FS_OSNAME_	L"iOS"
#else
