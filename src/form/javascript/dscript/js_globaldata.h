...
class CJS_KeyValue;
class CFXJS_GlobalVariableArray;
class CJS_GlobalData_Element;

class CFXJS_GlobalVariableArray
{
public:
	CFXJS_GlobalVariableArray();
	virtual ~CFXJS_GlobalVariableArray();

	void			Add(CJS_KeyValue* p);
	int				Count() const;
	CJS_KeyValue*	GetAt(int index) const;
	void			Copy(const CFXJS_GlobalVariableArray& array);
...
public:
	...
	CFXJS_GlobalVariableArray			objData;
};
...
{
public:
	CFXJS_GlobalData(CFSCRT_LTAppHandler* pApp);
	virtual ~CFXJS_GlobalData();
...
public:
	...
	void								SetGlobalVariableObject(FX_LPCSTR propname, const CFXJS_GlobalVariableArray& array);
