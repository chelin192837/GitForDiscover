...
class CFXJS_PublicMethods : public CFXJS_Object
{
public:
	CFXJS_PublicMethods(JSFXObject * pObject) : CFXJS_Object(pObject) {};
	virtual ~CFXJS_PublicMethods(void){};
...
public:
    ...
    static FX_BOOL			IsPM(const CFX_WideString& value, FX_BOOL bDouble, int nStart, int& nSkip);
...
public:
	...
	static CFXJS_Array		AF_MakeArrayFromList(CFXJS_Value val);
};
